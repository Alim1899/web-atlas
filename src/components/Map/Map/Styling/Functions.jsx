...
if(["brucela_humans","brucela_animals"].includes(layerName)){
  ...
  if(['anthrax',"anthrax_humans","anthrax_animals"].includes(layerName)){
    if (type === "1") return [20,20];
        if (type === "2-3") return [27, 27];
        if (type === "4-6") return [36, 36];
        if (type == "8-10") return [45, 45];
        if (type == "30-50") return [20, 20];
        if (type == "70-90") return [30, 30];
        if (type == "213") return [55, 55];
        return [20,20]
  }
