...
import { pointToLayer, polygonStyle, lineToLayer, onEachLine, onEachPolygonFeature, onEachPointFeature } from "./Styling/Styling";
  ...
  return (
    <>
      {layersToDisplay.map((el) => {
        ...
        onEachPolygonFeature(feature, layer, isTop,el[0])
      }
